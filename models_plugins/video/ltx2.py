...
class LTX2Plugin(ModelPlugin):
    ...
    def load(self, prefs, scene, **kw):
        ...
        pipe = LTX2ImageToVideoPipeline.from_pretrained(self.MODEL_ID, torch_dtype=torch.bfloat16)
    ...
    def generate(self, pipe_obj, inputs: ModelInputs, scene, prefs):
        ...
        # Stage 1
        print("LTX-2: Stage 1 — image → latents")
        ...
        print("LTX-2: Stage 1.5 — latent upsampling")
